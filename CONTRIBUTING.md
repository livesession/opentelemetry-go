...
```sh
$ go get -d github.com/livesession/opentelemetry-go
```

(This may print some warning about "build constraints exclude all Go
files", just ignore it.)

This will put the project in `${GOPATH}/src/github.com/livesession/opentelemetry-go`. You
...
(Note that `git clone` is *not* using the `github.com/livesession/opentelemetry-go` name -
